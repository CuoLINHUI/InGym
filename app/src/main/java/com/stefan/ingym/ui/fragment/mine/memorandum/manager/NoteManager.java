package com.stefan.ingym.ui.fragment.mine.memorandum.manager;
...
import com.stefan.ingym.ui.fragment.mine.memorandum.activity.ContentActivity;
import com.stefan.ingym.ui.fragment.mine.memorandum.dialog.EditDialog;
...
/*    public void addDescription(){
        Note description = new Note(mContext.getResources().getString(R.string.title_des),new Date(),
                mContext.getResources().getString(R.string.memorandum_title),
    ...
    public void deleteClick(int position){
        ...
        delete(select_item);
        MsgToast.showToast(mContext,"已删除该条记录");
    }
