...
import com.stefan.ingym.ui.fragment.community.moments.spannable.CircleMovementMethod;
import com.stefan.ingym.ui.fragment.community.moments.spannable.SpannableClickable;
...
public class PraiseListView extends TextView {
    ...
    public void setDatas(List<LikeItem> datas) {
        this.datas = datas;
    ...
    public void notifyDataSetChanged(){
        ...
        if(datas != null && datas.size() > 0){
            ...
            for (int i=0; i<datas.size(); i++){
                item = datas.get(i);
                if(item != null){
                    builder.append(setClickableSpan(item.getUser().getNickname(), i));// TODO: 2017/12/2
                    if(i != datas.size()-1){
                        builder.append(", ");
                    }
                }
