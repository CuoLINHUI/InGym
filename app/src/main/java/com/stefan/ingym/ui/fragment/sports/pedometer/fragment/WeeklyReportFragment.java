...
import com.stefan.ingym.ui.fragment.sports.pedometer.model.ActivityChart;
    ...
    private void generateReports(boolean updated) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MMMM份dd", locale);
                SimpleDateFormat simpleDateMonthFormat = new SimpleDateFormat("dd日", locale);
