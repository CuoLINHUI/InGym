...
*/
package com.stefan.ingym.ui.fragment.sports.pedometer.service;
...
import com.stefan.ingym.ui.fragment.sports.pedometer.activity.TrainingActivity;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected Notification buildNotification(StepCount additionalStepCount) {
        ...
        mBuilder.setContentTitle(getString(R.string.pedometer_chinese_name))
                .setContentText(message)
                .setTicker(message)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(getString(R.string.pedometer_chinese_name)))
